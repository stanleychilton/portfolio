...
if($count == 1) {
    ...
    $sql = $conn->query("UPDATE users SET hash = '".$hash."' WHERE email='".$email."'");
    
    $strSQL = "SELECT Firstname, Lastname FROM users WHERE email = '$email' LIMIT 1";
    ...
    $mail->Body    = "<h1>Password Reset</h1><br>
                      click the link below to reset your password!<br>
                      <a href='http://clicker-box.com/clickerbox/reset.php?email=$email&hash=$hash'>Reset</a>
                      <br><br>Regards
    ...
    $msg = 'Could not find that email in the system';
}
}
    ...
    <body style = 'padding-right: 0px;'>
        ...
        <div id="mainfield">
            ...
            <div class="row" style="margin-right:0px;margin-left:0px">
				...
				<p id="chardiv">Input the email associated with this account</p><br>
				<form id="chardiv" action = "" method = "post">
				  <label>email </label><input type = "email" name = "email" class = "box" /><br/><br />
				  <input type = "submit" value = " Submit "/><br />
				</form>
				<div id="chardiv" style = "font-size:11px; color:#cc0000; margin-top:10px"><?php echo $msg; ?></div>
					</div>
				<?php
				if ($mobile == 0){
				?>
