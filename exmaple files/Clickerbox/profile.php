...
$sql = "SELECT Firstname, Lastname, Username, DOB, Creation_time, Gender, Image FROM users WHERE username = '$foo'";
				...
				<div class="row">
					<div class="col-md-6">
						<div class='side-crop'>
							<?php
							if($row['Image'] == NULL){
								echo "<img src='user_images/profile/default.jpg' id='profile_img'>";
							}else{
								echo "<img src='" . $row['Image'] . "' id='profile_img' >";
							}
							?>
						</div>
					</div>
					...
					<div id="details">
						...
						echo "<h4><strong>" . $row['Username'] . "</strong></h4>";
						echo "<h4><strong>score: coming soon</strong></h4><br>";
						
						$newDate = date("m-d-Y", strtotime($row['DOB']));
						echo "<h4>". $newDate ."</h4>";
						echo "<h4>". $row['Gender'] ."</h4>";
						//echo "<h4><strong>". $row[''] ."</strong></h4><br>";
						?>	
						</div>
					</div>
				</div>
				<br>
				<?php if ($foo == $login_session){?>
				<button class='button1' onclick="window.location.href = 'settings.php';">
				<div class="row">
					<div class="col-md-12">
						<h5>Settings</h5>
					</div>
