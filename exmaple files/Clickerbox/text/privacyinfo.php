        ...
        <div style="padding-right: 15px;padding-left: 15px;margin-right: auto;margin-left: auto;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>
                        Privacy Policy of http://www.clicker-box.com
                    </p>
                </div>
            </div>
        </div>
...
<p>clicker-box ("us", "we", or "our") operates the http://www.clicker-box.com website (the "Service").</p>

<p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. Our Privacy Policy  for clicker-box is managed through <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy</a>.</p>

<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from http://www.clicker-box.com</p>
...
<p>clicker-box uses the collected data for various purposes:</p>    
<ul>
...
<p>clicker-box will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h2>Disclosure Of Data</h2>

<h3>Legal Requirements</h3>
<p>clicker-box may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of clicker-box</li>
...
<ul>
            <li>By visiting this page on our website: http://www.clicker-box.com/clickerbox/contactus.php</li>
...
<p>Fecha efectiva: October 09, 2018</p>


<p>clicker-box ("nosotros", "a nosotros", "nuestro") opera el sitio web http://www.clicker-box.com (en adelante, el "Servicio").</p>

<p>Esta página le informa de nuestras políticas en materia de recopilación, uso y divulgación de datos personales cuando utiliza nuestro Servicio y de las opciones de las que dispone en relación con esos datos. <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Política de privacidad via Free Privacy Policy</a>.</p>

<p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros Términos y Condiciones, disponibles en el http://www.clicker-box.com</p>

<h2>Definiciones</h2>
<ul>
    <li>
        <p><strong>Servicio</strong></p>
                <p>Servicio es el sitio web http://www.clicker-box.com operado por clicker-box</p>
            </li>
    <li>
...
<h2>Uso de datos</h2> 
<p>clicker-box utiliza los datos recopilados con diversas finalidades:</p>    
<ul>
...
<p>Si usted se encuentra fuera de New Zealand y decide facilitarnos información, tenga en cuenta que nosotros transferimos los datos, incluyendo Datos personales, a New Zealand y que los tratamos allí.</p>
...
<ul>
            <li>Visitando esta página en nuestro sitio web: http://www.clicker-box.com/clickerbox/contactus.php</li>
...
<p>Date de prise d'effet: October 09, 2018</p>


<p>clicker-box ("nous", "notre", "nos") exploite le site web http://www.clicker-box.com (ci-après désigné par le terme "Service").</p>
...
<p>clicker-box utilise les données recueillies à des fins diverses:</p>    
<ul>
...
<p>Si vous résidez hors de/du New Zealand et que vous choisissez de nous communiquer des informations, sachez que nous transférons les données, y compris les Données à Caractère Personnel, vers le/la New Zealand et que nous les y traitons.</p>
...
<ul>
            <li>En consultant cette page sur notre site web: http://www.clicker-box.com/clickerbox/contactus.php</li>
...
<p>Datum des Inkrafttretens: October 09, 2018</p>


<p>clicker-box ("wir", "uns", "unser" usw.) betreibt die Website http://www.clicker-box.com (nachstehend als "Dienst" bezeichnet).</p>
...
<h2>Datennutzung</h2> 
<p>Wir bei clicker-box nutzen die erfassten Daten für verschiedene Zwecke, beispielsweise um:</p>    
<ul>
...
<p>Falls Sie sich außerhalb von New Zealand befinden und sich dazu entscheiden, Daten an uns zu übermitteln, müssen Sie zur Kenntnis nehmen, dass wir Ihre Daten, einschließlich personenbezogener Daten, nach New Zealand übertragen und diese dort verarbeiten.</p>
...
<ul>
            <li>Durch Besuch der folgenden Seite unserer Website: http://www.clicker-box.com/clickerbox/contactus.php</li>
...
<p>Data di entrata in vigore: October 09, 2018</p>


<p>clicker-box ("noi" o "nostro") gestisce il http://www.clicker-box.com sito web (in appresso il "Servizio").</p>
...
<h2>Uso dei dati</h2> 
<p>clicker-box utilizza i dati raccolti per vari scopi:</p>    
<ul>
...
<p>Se ci si trova al di fuori di New Zealand e si sceglie di fornire informazioni a noi, si ricorda che trasferiamo i dati, compresi i dati personali, in New Zealand e li elaboriamo lì.</p>
...
<ul>
            <li>Visitando questa pagina sul nostro sito web: http://www.clicker-box.com/clickerbox/contactus.php</li>
...
<p>Ingangsdatum: October 09, 2018</p>


<p>clicker-box ("ons", "wij" of "onze") beheert de http://www.clicker-box.com website ("hierna genoemd Dienst").</p>

<p>Deze pagina bevat informatie over ons beleid met betrekking tot de verzameling, het gebruik en de openbaarmaking van uw persoonsgegevens wanneer u onze Dienst gebruikt en de keuzes die u hebt met betrekking tot die gegevens. <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Privacybeleid via Free Privacy Policy</a>.</p>
...
<ul>
    <li>
        <p><strong>Dienst</strong></p>
                <p>Onder dienst verstaan wij de http://www.clicker-box.com website beheerd door clicker-box</p>
            </li>
    <li>
...
<p>clicker-box gebruikt de verzamelde gegevens voor uiteenlopende doeleinden:</p>    
<ul>
...
<p>Let erop dat, als u zich buiten New Zealand bevindt en u ons gegevens verstrekt, wij deze gegevens, inclusief Persoonsgegevens, overdragen naar New Zealand en ze daar verwerken.</p>
...
<p>clicker-box zal alle redelijkerwijs noodzakelijke stappen ondernemen om ervoor te zorgen dat uw gegevens veilig en in overeenstemming met dit Privacybeleid worden behandeld en dat uw Persoonsgegevens nooit worden overgedragen aan een organisatie of een land als er geen gepaste controles zijn ingesteld, inclusief de veiligheid van uw gegevens en andere persoonsgegevens.</p>

<h2>Openbaarmaking van gegevens</h2>

<h3>Wettelijke vereisten</h3>
<p>clicker-box kan uw Persoonsgegevens openbaar maken als het te goeder trouw de mening is toegedaan dat een dergelijke handeling noodzakelijk is:</p>
<ul>
    <li>Om te voldoen aan een wettelijke verplichting</li>
    <li>Om de rechten en eigendom van clicker-box te beschermen en te verdedigen</li>
...
<ul>
            <li>Via deze pagina op onze website: http://www.clicker-box.com/clickerbox/contactus.php</li>
