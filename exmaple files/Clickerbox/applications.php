        ...
        <div id="mainfield">
            ...
            <div class="row" style="margin-right:0px;margin-left:0px">
                ...
                <div class="col-md-6 col-md-offset-0" style = 'padding-right: 0px;padding-left: 0px;'>
					...
					$sql = "SELECT id ,username, message FROM application";
					...
					if ($result->num_rows > 0) {
						...
						while($row = $result->fetch_assoc()) {
							...
							" <br>User: ". $row['username'].
							" <br>Reasons: ". $row['message']."</div>".
							"<td><a href='accept.php?user=".$row['username']."'>Accept</a></td>
							<td><a href='decline.php?user=".$row['username']."'>Decline</a></td><br><br>";
