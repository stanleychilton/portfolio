            ...
            <div class="row" style="margin-right:0px;margin-left:0px">
                ...
                <div class="col-md-6 col-md-offset-0" style = 'padding-right: 0px;padding-left: 0px;'>
					...
					if ($result->num_rows > 0) {
						echo "<div id='chardiv'><h3>Public Categories:</h3></div>";
						// output data of each row
						while($row = $result->fetch_assoc()) {
							$topics = $conn->query("SELECT COUNT(id) FROM post WHERE cat_id = ".$row['id']);
							$topic_result = mysqli_fetch_array($topics);
							echo "<tr class='maintr maintrhover'><td id='maintd'><a href='pub_cat.php?id=".$row['id']."' id='maintda'>".$row["topic"]."</a></td>";
							echo "<td><a href='pub_cat.php?id=".$row['id']."' id='texteditb'>$topic_result[0] Posts</a></td></tr>";
						}
					} else {
						echo "0 results";
					}
