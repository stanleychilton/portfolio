       ...
       // if no urls in the text just return the text
        ...
        if(file_exists($_FILES['attachment']['tmp_name']) || is_uploaded_file($_FILES['attachment']['tmp_name'])){
            ...
            if ($_FILES['attachment']['size'] > 50000000)
                ...
                $msg = "File Uploaded!";
                $query   = "INSERT into post (cat_id,Mod_name,Date,topic,image,ip) VALUES('" . $id . "','" . $name . "','" . $date . "','" . $topic . "','" . $destFile . "','" . $ip . "')";
        }else{
            $query   = "INSERT into post (cat_id,Mod_name,Date,topic,ip) VALUES('" . $id . "','" . $name . "','" . $date . "','" . $topic . "','" . $ip . "')";
        }
