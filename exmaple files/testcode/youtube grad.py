...
while running:
    ...
    screen.fill(white)
    button1(bar, bar_y, 75, 2, grey, action="scroll1")
    button1(bar, bar_y+sep, 75 ,2, grey, action="scroll2")
    button1(bar, bar_y+sep*2, 75 ,2, grey, action="scroll3")
    ...
    button("", x, y, width, height, colour, colour, action="custom")
