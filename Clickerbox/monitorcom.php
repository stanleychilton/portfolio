        ...
        <div id="mainfield">
            ...
            <div class="row" style="margin-right:0px;margin-left:0px">
                ...
                <div class="col-md-6 col-md-offset-0" style = 'padding-right: 0px;padding-left: 0px;'>
					<?php
					$sql = "SELECT id, date, comment, image, active FROM comments";
					...
					if ($result->num_rows > 0) {
						...
						while($row = $result->fetch_assoc()) {
							...
							echo "<br><p><a class='button' id='textedit' href='deletecom.php?id=".$row['id']."' style='background-color: red;'>Delete</a> ";
							if($row["active"]==0){
								echo " <a class='button' id='textedit' href='postdisplay.php?id=".$row['id']."&t=4' style='background-color: orange;'>Hide post</a>";
							}else if($row["active"]==1){
								echo " <a class='button' id='textedit' href='postdisplay.php?id=".$row['id']."&t=4' style='background-color: green;'>Display post</a>";
							}
							echo "</p><br><br></div>";
						}
					} else {
