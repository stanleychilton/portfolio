...
$target_dir = "user_images/anon_post/";
...
$cat_check = "SELECT cat_id FROM anon_post WHERE id = '$foo'";
       ...
       // if no urls in the text just return the text
        ...
        if(file_exists($_FILES['attachment']['tmp_name']) || is_uploaded_file($_FILES['attachment']['tmp_name'])){
            ...
            if ($_FILES['attachment']['size'] > 50000000)
                ...
                $msg = "File Uploaded!";
                $query   = "INSERT into anon_comments (post_id,Date,comment,image,ip) VALUES('" . $id . "','" . $date . "','" . $comment . "','" . $destFile . "','" . $ip . "')";
        } else {
        ...
        <div id="mainfield">
            ...
            <div class="row" style="margin-right:0px;margin-left:0px">
                ...
                <div class="col-md-6 col-md-offset-0 results" style = 'padding-right: 0px;'>
					<?php
					$sql = "SELECT id, mod_name, date, topic, image FROM anon_post WHERE id = '$foo'";
...
?>					<?php
					...
					?>
						<br><div class='warncard'><p>You must be <a href='login.php'>Logged in</a> to comment!<p></div>
					<?php
						}
					?>
                </div>
